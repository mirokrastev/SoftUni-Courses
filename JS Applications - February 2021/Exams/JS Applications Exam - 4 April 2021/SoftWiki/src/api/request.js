...
export default function apiReq() {
    ...
    return {
        ...
        async login(formData, ...exclude) {
            ...
            if (!body['email'] || !body['password']) throw new Error('Invalid form.');
        ...
        async register(formData) {
            ...
            if (!data['email'] || !data['password'] || !data['rep-pass']
            || body['password'] !== data['rep-pass']) throw new Error('Invalid form.');
